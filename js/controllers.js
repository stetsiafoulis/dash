...
//              data: [65, 59, 40, 51, 36, 25, 40]
				data: [4596314.49, 4415576.57, 2698411.56, 4448659.79, 98724560.65, 3166371.76, 3513275.58]
            },
            {
                label: "Example dataset",
                fillColor: "rgba(26,179,148,0.5)",
...
//              data: [48, 48, 60, 39, 56, 37, 30]
				data: [185272.30, 179612.56, 359263.78, 176462.15, 218977.33, 192449.18, 100382.75]
            }
        ]
    };
...
function paymentsCtrl($scope, $http) {
	...
	$http.get('json/OTEPayments4.json')
       .then(function(res){
			$scope.otepayments = res.data.DataForTableOTEPaymentsDtls;
        });
}
